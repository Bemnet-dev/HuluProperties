      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-zinc-900 mb-2 uppercase tracking-tight">Create Account</h1>
            <p className="text-zinc-500 font-medium">Join Hulu Properties to save your favorites</p>
          </div>
