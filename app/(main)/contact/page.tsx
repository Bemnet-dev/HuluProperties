              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <select name="interest" className="w-full bg-white border border-zinc-200 pl-5 pr-12 py-4 rounded-2xl hover:border-zinc-300 hover:shadow-sm focus:ring-2 focus:ring-emerald-800 focus:border-transparent outline-none transition-all font-medium appearance-none cursor-pointer">
                      <option>Premium Real Estate</option>
                      <option>Fine Vehicles</option>
                      <option>Land Development</option>
                      <option>Institutional Investment</option>
                    </select>
                    <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 text-zinc-400 pointer-events-none group-hover:text-zinc-600 transition-colors" size={20} />
                  </div>
                </div>
                <div className="space-y-2">
