      ...
      <div className="bg-white border-b border-zinc-200 py-12 px-6 md:px-12">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between w-full">
            <div className={`flex items-center gap-2 bg-zinc-100 p-1.5 rounded-xl w-full lg:w-auto overflow-x-auto ${showFilters ? 'block' : 'hidden'}`}>
            ...
            <div className="flex w-full lg:w-auto gap-4 items-center">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 bg-white border border-zinc-200 text-zinc-700 px-4 py-3 rounded-xl hover:bg-zinc-50 transition-colors shadow-sm font-medium whitespace-nowrap"
              >
                <Filter size={20} /> <span className="hidden sm:inline">Filters</span>
              </button>
              <div className="hidden sm:flex bg-white border border-zinc-200 rounded-xl p-1 shadow-sm">
